...
# book = openpyxl.load_workbook('Sheets\\attendance.csv')
book = openpyxl.load_workbook('Sheets\\attendance1.xlsx') 
# Choose the sheet 
sheet = book['Sheet1'] 
...
def savefile(): 
    # book.save(r'sheets\\attendance.csv')
    book.save(r'Sheets\\attendance1.xlsx')  
    print("saved!") 
...
# for students 
def mailstu(li, msg): 
    from_id = 'newproject7797@gmail.com'
    pwd = 'Newproject@7797'
...
while resp is 1: 
    ...
    if(no_of_absentees > 1): x = list(map(int, (input('roll nos :').split(' ')))) 
    else: x = [int(input('roll no :'))] 
